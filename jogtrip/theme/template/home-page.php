               ...
               <div class="row">
                  <div class="logo-area clearfix">
                     <div class="logo col-lg-4 col-md-12">
                        <a href="index.php">
                           <img src="images/logo-jogtrip.png" alt="">
                        </a>
                     </div>
                     <!-- logo end-->
                  </div>
               ...
               <div class="container">
                  <nav class="navbar navbar-expand-lg ">
                     ...
                     <div class="collapse navbar-collapse justify-content-start" id="navbarSupportedContent">
                        <ul class="navbar-nav">
                           <li class="nav-item dropdown active"><a class="nav-link" href="index.php">Home</a>
                           </li>
                           <!-- li end-->
                           <li class="nav-item dropdown"><a class="nav-link" href="#" data-toggle="dropdown">Wisata<i class="fa fa-angle-down"></i></a>
                              <ul class="dropdown-menu" role="menu">
                                 <li><a href="main-fitur/alam.php">Alam</a></li>
                                 <li><a href="main-fitur/senibudaya.php">Seni dan Budaya</a></li>
                              </ul>
                           </li> 
                           <!-- li end-->
                           <li class="nav-item dropdown"><a class="nav-link" href="main-fitur/room.php">Hotel</a>
                           </li>
                           <!-- li end-->
                           <li class="nav-item dropdown"><a class="nav-link" href="main-fitur/restaurant.php">Restaurant</a>
                           </li>
                           <!-- li end-->
                        </ul>
                        <!--Nav ul end-->
                     </div>
                     <a href="loginRegister/Login.php" class="top-right-btn btn btn-primary btnlogin-popup">Login Admin</a>
                     <!-- Top bar btn -->
                  </nav>
                  <!-- Collapse end-->
               </div>
               ...
               <div class="container">
                  <div class="slider-content text-left">
                     <div class="col-md-12">
                        ...
                        <p><a class="slider btn btn-primary" href="main-fitur/alam.php">Gass!</a></p>
                     </div>
                     <!-- Col end-->
                  </div>
                  <!-- Slider content end-->
               ...
               <div class="container">
                  <div class="slider-content text-right">
                     <div class="col-md-12">
                        ...
                        <p><a class="slider btn btn-primary" href="main-fitur/restaurant.php">Gass!</a></p>
                     </div>
                     <!-- Col end-->
                  </div>
                  <!-- Slider content end-->
            ...
            <div class="row feature-light-row">
               <div class="col-md-3 text-center">
                  <div class="ts-feature-box">
                     <div class="ts-feature-info">
                        ...
                        <p>JogTrip, Menghubungkanmu dengan Alam Jogja yang Spektakuler. Tak hanya destinasi, tapi pengalaman yang abadi.</p>
                        <a class="slider btn btn-primary" href="main-fitur/alam.php">Go</a>
                     </div>
                  </div>
                  <!-- feature box-1 end-->
               </div>
               ...
               <div class="col-md-3 text-center border-left">
                  <div class="ts-feature-box">
                     <div class="ts-feature-info">
                        <div class="feature-img">
                           <img src="images/icon/fitur-wisata_senibudaya.png" alt="" />
                        </div>
                        <h3 class="ts-feature-title">Wisata Seni Budaya</h3>
                        <p>JogTrip, Membimbingmu ke Keajaiban Seni dan Budaya Jogja. Bersiaplah untuk Menjadi Bagian dari Kisah Ini!</p>
                        <a class="slider btn btn-primary" href="main-fitur/senibudaya.php">Go</a>
                     </div>
                  </div>
                  <!-- feature box-2 end-->
               </div>
               <div class="col-md-3 text-center border-left">
                  <div class="ts-feature-box">
                     <div class="ts-feature-info">
                        ...
                        <a class="slider btn btn-primary" href="main-fitur/room.php">Go</a>
                     </div>
                  </div>
                  <!-- feature box-2 end-->
               </div>
               ...
               <div class="col-md-3 text-center border-left">
                  <div class="ts-feature-box">
                     <div class="ts-feature-info">
                        ...
                        <a class="slider btn btn-primary" href="main-fitur/restaurant.php">Go</a>
                     </div>
                  </div>
                  <!-- feature box-2 end-->
               </div>
