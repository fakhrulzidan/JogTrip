...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 10 Des 2023 pada 14.37
...
INSERT INTO `hotel` (`id_hotel`, `nama_hotel`, `deskripsi_hotel`, `lokasi_hotel`, `daerah_hotel`, `gambar_hotel`, `status_hotel`) VALUES
(1, 'OYO', 'OYO Rooms, umumnya dikenal sebagai OYO, adalah jaringan layanan perhotelan dan hotel hemat di India. Didirikan pada 2013 oleh Ritesh Agarwal dan sejak itu berkembang menjadi sekitar 8.500 hotel di kota-kota di India, Malaysia, Nepal, Tiongkok, dan Indonesia.', '0', 'Sleman', 'https://images.oyoroomscdn.com/uploads/hotel_image/49915/5efb305b6231718c.jpg', 'rekomendasi'),
(3, 'Reddoorz', 'RedDoorz merupakan jaringan penginapan budget online terbesar di Indonesia. Berfokus pada perkembangan penginapan dan distribusi penjualan secara online. RedDoorz akan memilih properti yang berpotensi untuk bekerja sama secara langsung dan terikat komitmen dengan brand RedDoorz.', '0', 'Sleman', 'https://reddoorz-near-jogja-city-mall-3-yogyakarta.hotelmix.id/data/Photos/OriginalPhoto/8102/810290/810290574/Reddoorz-Near-Jogja-City-Mall-3-Sleman-Exterior.JPEG', 'rekomendasi'),
(4, 'The Rich Jogja Hotel', 'The Rich Jogja Hotel The Rich Jogja Hotel merupakan sebuah destinasi sebagai akomodasi penginapan hotel berbintang empat yang berada di Yogyakarta. The Rich Jogja Hotel merupakan hotel berkonsep MICE (Meeting, Incentive, Conference dan Exhibition) yang mulai beroperasi pada tahun 2012.', 'https://maps.app.goo.gl/x3v8P7FCKUvvtnA69', 'Sleman', 'https://cf.bstatic.com/xdata/images/hotel/max1024x768/501213311.jpg?k=56a59979b91043dbc0820b453ea14e1035386b461d9f5909de73002b85674b6a&o=&hp=1', 'rekomendasi');
...
INSERT INTO `resto` (`id_resto`, `nama_resto`, `daerah_resto`, `lokasi_resto`, `deskripsi_resto`, `gambar_resto`, `status_resto`) VALUES
...
INSERT INTO `wisata` (`id_wisata`, `nama_wisata`, `daerah_wisata`, `deskripsi_wisata`, `lokasi_wisata`, `gambar_wisata`, `jenis_wisata`, `status_wisata`) VALUES
(1, 'Bukit Paralayang', 'Bantul', 'Bukit Paralayang merupakan bukit yang digunakan untuk terbang layang dengan menikmati hamparan kebun teh yang menghijau. tidak hanya itu, ditempat ini kita juga dapat camping, outbound atau hanya sekedar bersantai menikmati pemandangan.', 'https://maps.app.goo.gl/Z8wTtFV3S1pd1yzo9', 'https://visitingjogja.jogjaprov.go.id/wp-content/uploads/2022/08/watu-gupit-by-@asaljepret39.jpg', 'alam', '-'),
(8, 'Heha Sky View', 'Gunung Kidul', 'Heha Sky View merupakan salah satu objek wisata yang terletak di kawasan perbukitan tepatnya di Jl. Dlingo No 02, Patuk,Gunungkidul, Daerah Istimewa Yogyakarta. Didirikan pada 18 September 2019 oleh Herry Zudianto, mantan Walikota Yogyakarta dan rekannya Handoyo Mawardi.', 'https://maps.app.goo.gl/mNm4n1ByeaAFdsjs8', 'https://bob.kemenparekraf.go.id/wp-content/uploads/2021/05/118781441_306738327097253_4000647999436703134_n.jpg', 'alam', 'rekomendasi'),
...
(14, 'Pantai Parangtritis', 'Bantul', 'Pantai Parangtritis adalah tempat wisata yang terletak di Kalurahan Parangtritis, Kapanéwon Kretek, Kabupaten Bantul, Daerah Istimewa Yogyakarta. Jaraknya kurang lebih 27 km dari pusat kota.', 'https://maps.app.goo.gl/8zECjbMEBZgMMc387', 'https://www.beritadaerah.co.id/wp-content/uploads/2020/09/Pantai-Parangtritis-Menyimpan-Keindahan-Tersendiri-Foto-Handoko-Kontributor-Beritadaerah-1.jpg', 'alam', 'rekomendasi'),
